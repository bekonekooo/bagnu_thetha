/// Kullanıcıya görünen kurumsal bilgiler tek yerde tutulur.
///
/// Vergi levhasındaki T.C. kimlik numarası ve gizli servis anahtarları bu
/// dosyada özellikle yer almaz.
class CompanyInfo {
  static const brand = 'Yeniden Kendine';
  static const operatorName = 'Bagnu Çorakçı Satıcı';
  static const businessType = 'Şahıs işletmesi';

  static const address = '''Güzeloba Mah. Rauf Denktaş Cad. No:56
İç Kapı No:102
Muratpaşa / Antalya
Türkiye''';
  ...
  static const paymentCompanyAddress =
