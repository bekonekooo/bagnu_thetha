          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 6),
                Text(
                  'Yaklaşan, devam eden ve bitmiş eğitimleri burada takip edebilirsin.',
                  style: TextStyle(
                    fontSize: 13.5,
                    height: 1.35,
                ...
                return ListView(
                  ...
                  children: [
                    ...
                    buildTrainingSection(
                      ...
                      items: upcoming,
                      emptyText: 'Yaklaşan eğitim bulunmuyor.',
                    ),
                    buildTrainingSection(
                      title: 'Devam Eden Eğitimler',
                      items: ongoing,
                      emptyText: 'Şu anda devam eden eğitim bulunmuyor.',
                    ),
                    buildTrainingSection(
                      title: 'Bitmiş Eğitimler',
                      items: completed,
                      emptyText: 'Bitmiş eğitim bulunmuyor.',
                    ),
                  ],
                );
              },
