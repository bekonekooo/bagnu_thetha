...
class _NotificationsPageState extends State<NotificationsPage> {
  ...
  static const String notificationsBackground =
  ...
  Widget buildActionBar(List<NotificationModel> notifications) {
    final unread = unreadCount(notifications);
  ...
  Widget buildNotificationCard(NotificationModel notification) {
    ...
    final cardOpacity = notification.isRead ? 0.48 : 0.62;
    final borderOpacity = notification.isRead ? 0.34 : 0.52;
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            ...
            width: notification.isRead ? 1 : 1.35,
          ),
          boxShadow: [
            BoxShadow(
              blurRadius: notification.isRead ? 16 : 24,
              color: Colors.black.withOpacity(
                notification.isRead ? 0.06 : 0.10,
              ),
